...
<body>
    <div class="container">
        <div class="row d-flex justify-content-center mt-5">
            <form action="singin.php?startSession" method="post" class="col-11 col-sm-10 col-md-8 col-lg-6 mt-5 p-4" style="border-radius:10px; border:1px solid #554dde; background:white;">
                ...
                <div class="mb-3">
                    ...
                    <input type="username" class="form-control" id="usuario" name="usuario" style="border:1px solid #554dde;">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label" style="color:#554dde; font-weight:600;">Contraseña</label>
                    <input type="password" class="form-control" id="contra" name="contra" style="border:1px solid #554dde;">
                </div>
