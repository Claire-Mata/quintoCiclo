...
Dibujar::Dibujar(QWidget *parent) :QWidget(parent)
{
    resize(600, 400);
    myTree = new ArbolBi();

}
bool Dibujar::setInput(QString input1, QString input2)
{
...
void Dibujar::draw(BinTreeNode *node, int x, int y, int angle, bool isLeft, int depth, QPainter *p)
{
